...
import static TravelGoodBPELClientTest.testBTest.convertDateTimeToGregCal;
...
public class testC1Test {
    ...
    public testC1Test() throws DatatypeConfigurationException {
    ...
    public void testC1(){
        ...
        try {
            ...
            assertFalse(true);
            Logger.getLogger(testC1Test.class.getName()).log(Level.SEVERE, null, ex);
        }
